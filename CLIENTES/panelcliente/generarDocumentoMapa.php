...
// Obtener los datos de la cotización y verificar que pertenezca al usuario
$query = "SELECT * FROM contratos_clientes_maps WHERE id='$cotizacionId' AND id_usuario='$userId'";
$result = $conn->query($query);

if ($result->num_rows == 0) {
    die("Cotización no encontrada o no pertenece al usuario.");
}
